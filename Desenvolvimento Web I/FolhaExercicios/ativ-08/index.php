...
<body>
    ...
    <form method="post">
        <h2>Simulador de Parcelas (Moto)</h2>
        <div class="block">
            <div class="fields">
            ...
            <div class="fields">
                ...
                <select id="parcelas" name="parcelas" required>
                    <option value="24">24 vezes (Taxa 1.5%)</option>
                    <option value="36">36 vezes (Taxa 2.0%)</option>
                    <option value="48">48 vezes (Taxa 2.5%)</option>
                    <option value="60">60 vezes (Taxa 3.0%)</option>
                </select><br>
            </div>
        </div>
